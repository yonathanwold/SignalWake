...
import type { AircraftObservation, CanonicalEvent, InfrastructureAsset, InfrastructureAssessment, LayerCatalogItem, MapLayerData, RainViewerMetadata, Source } from "../lib/types";
import { AircraftInspector, EventFeed, EventInspector, InfrastructureInspector } from "./event-feed";
...
export function Dashboard({ view = "map" }: { view?: "map" | "feed" }) {
  ...
  const [selectedAircraft, setSelectedAircraft] = useState<AircraftObservation | null>(null);
