...
- `LIVE` means a successful startup fetch, normalization, and persistence pass from a connected event adapter: NWS alerts, NWS station observations, USGS earthquakes, bounded USGS water states, NHC systems, NOAA CO-OPS, NASA EONET, AviationWeather.gov PIREPs, current FEMA designated counties, or configured Road511/NASA FIRMS/AirNow. Operational API pages are bounded to 2,000 records within the past 48 hours.
